<title>PAUD Sri Rejeki - Edit Jenis Pembayaran</title>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?php base_url("jenisbayar/edit") ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="<?php echo $jenisbayar->kode_jenis?>" />

                                            <div class="form-group">
                                                <label for="kode_jenis">Kode Jenis</label>
                                                <input class="form-control <?php echo form_error('kode_jenis') ? 'is-invalid' : '' ?>" type="text" name="kode_jenis" value="<?php echo $jenisbayar->kode_jenis ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?php echo form_error('jenis_bayar') ? 'is-invalid' : '' ?>" type="text" name="jenis_bayar" value="<?php echo $jenisbayar->jenis_bayar ?>" />
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?php echo form_error('dateline') ? 'is-invalid' : '' ?>" type="date" name="dateline" value="<?php echo $jenisbayar->dateline ?>" />
                                                <div class="invalid-feedback">
