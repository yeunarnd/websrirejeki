  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('dashboard') ?>">
        ...
        <div class="sidebar-brand-text mx-3">YieunGelato</sup></div>
      </a>
				...
				<div class="card mb-3">
                    ...
                    <th>Nama Barang</th>
								...
								<tbody>
									...
									<tr>
										<td width="150">
											<?php echo $products->kode_barang ?>
										</td>
										<td>
											<?php echo $products->nama_barang ?>
										</td>
                    <td>
											<?php echo $products->harga ?>
										</td>
										<td>
											<img src="<?php echo base_url('uploads/'.$products->gambar) ?>" width="64" />
										</td>
										<td width="250">
											<a href="<?php echo site_url('products/edit/'.$products->kode_barang) ?>"
											 class="btn btn-small text-primary"><i class="fas fa-edit"></i> Edit</a>
                       <a onclick="return confirm('Apakah anda yakin?')" href="<?php echo site_url('products/delete/'.$products->kode_barang) ?>" 
...
<span>Copyright &copy; YieunGelato 2020</span>
</div>
</div>
</footer>
<!-- End of Footer -->
