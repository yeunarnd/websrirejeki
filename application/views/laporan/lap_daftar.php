        ...
        <div class="col-lg">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('laporan/export_pendaftaran') ?>" class="btn btn-secondary" style="float:right"><i class="fa fa-download"></i> Unduh Laporan</a>
                </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($daftar as $daftar) : ?>
                                    <tr>
                                        ...
                                        <td width="250">
                                            <a href="<?= base_url('laporan/details/') . $daftar['kd_daftar']; ?>" class="badge badge-info"> Detail</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
